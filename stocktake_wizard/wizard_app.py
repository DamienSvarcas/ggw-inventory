...
def main():
    ...
    with col_btn:
        st.markdown(
            '<a href="http://localhost:8501" target="_self" style="display:inline-block;padding:0.5rem 1rem;background:#f0f2f6;border:1px solid #ddd;border-radius:0.5rem;text-decoration:none;color:#31333F;font-size:0.9rem;">📊 Inventory Dashboard</a>',
            unsafe_allow_html=True
        )
